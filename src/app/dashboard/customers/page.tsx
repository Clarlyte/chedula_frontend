      ...
      <div className="responsive-container relative z-10">
        <div className="flex justify-between items-center mb-8">
          <div className="space-y-2">
            <h1 className="text-3xl font-bold tracking-tighter text-gold-400">Customers</h1>
            <p className="text-muted-foreground">Manage and track your customer information</p>
          </div>
